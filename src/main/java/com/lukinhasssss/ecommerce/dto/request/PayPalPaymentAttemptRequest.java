...
public class PayPalPaymentAttemptRequest {
    ...
    public PayPalPaymentAttemptRequest() {
    }

    public PayPalPaymentAttemptRequest(Long purchaseId, String transactionId, TransactionStatus status) {
